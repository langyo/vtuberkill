  ...
  return {
    ...
    character: {
      ...
      Joi: [
        ...
        3,
        ["pianxin", "yuancheng"],
        ["guoV", "doublegroup:qun:VirtuaReal"],
      ],
    ...
    dynamicTranslate: {
      tiantang(player) {
        ...
        if (player.$.haoren === true)
          return `<font color=#fcd>${str
            .slice(0, str.indexOf(`（`))
            .replace(/弃置/g, `重铸`)}</font>${str.slice(str.indexOf(`（`))}`;
        return str;
      },
      liying(player) {
        ...
        if (player.$.fuyu === true)
          return `<font color=#fcd>${str
            .slice(0, str.indexOf(`（`))
            .replace(/基本/g, `通常锦囊`)}</font>${str.slice(
            str.indexOf(`（`)
          )}`;
        return str;
      },
      gunxun(player) {
        ...
        switch (player.$.gunxun) {
          case 1:
            return str
              .replace(/①红色/g, `<span class="firetext">①红色</span>`)
              .replace(/①【杀】/g, `<span class="firetext">①【杀】</span>`);
          case 2:
            return str
              .replace(/②黑色/g, `<span class="browntext">②黑色</span>`)
              .replace(/②【闪】/g, `<span class="browntext">②【闪】</span>`);
        }
      },
      fengqing(player) {
        ...
        switch (player.$.fengqing) {
          case 1:
            return str.replace(
              /①视为使用了【酒】/g,
              `<span class="changetext">①视为使用了【酒】</span>`
            );
          case 2:
            return str.replace(
              /②视为使用了【桃】/g,
              `<span class="changetext">②视为使用了【桃】</span>`
            );
          case 3:
            return str.replace(
              /③跳过本回合的判定和弃牌阶段/g,
              `<span class="changetext">③跳过本回合的判定和弃牌阶段</span>`
            );
        }
        return str;
      },
      erni(player) {
        ...
        switch (player.$.erni) {
          case 1:
            return str.replace(
              /①【杀】/g,
              `<span class="changetext">①【杀】</span>`
            );
          case 2:
            return str.replace(
              /②【闪】/g,
              `<span class="changetext">②【闪】</span>`
            );
          case 3:
            return str.replace(
              /③【桃】/g,
              `<span class="changetext">③【桃】</span>`
            );
        }
        return str;
      },
      luqiu(player) {
        ...
        switch (player.$.luqiu) {
          case 1:
            return str.replace(
              /①视为使用一张【杀】/g,
              `<span class="changetext">①视为使用一张【杀】</span>`
            );
          case 2:
            return str.replace(
              /②摸一张牌/g,
              `<span class="changetext">②摸一张牌</span>`
            );
          case 3:
            return str.replace(
              /③弃一张牌/g,
              `<span class="changetext">③弃一张牌</span>`
            );
        }
        return str;
      },
      qianjiwanbian(player) {
        ...
        return player.$.qianjiwanbian_change
          ? str.replace(
              /雷电/g,
              `<span class="changetext">${get.rawName(
                player.$.qianjiwanbian_change
              )}</span>`
            )
          : str;
      },
      shangsheng(player) {
        ...
        return num
          ? str.replace(/1/g, `<span class="changetext">${num}</span>`)
          : str;
      },
      lianyin(player) {
        ...
        if (player.awakenedSkills.includes(`guixiang`)) {
          return str.replace(
            /使用/g,
            `<span class="changetext">使用或打出</span>`
          );
        }
        return str;
      },
      ...
      shixi(player) {
        ...
        if (player.$.yuezhi) {
          return str.replace(
            /（你）/g,
            `<span class="changetext">（你或一名<皇珈骑士>）</span>`
          );
        }
        return str;
      },
      mmjieyuan(player) {
        ...
        if (player.$.mmjieyuan_change) {
          return str.replace(
            /两\/一/g,
            `<span class="changetext">一/两</span>`
          );
        }
        return str;
      },
      ...
      daoyi(player) {
        ...
        switch (player.$.daoyi) {
          case 0:
            return str.replace(
              /①颜色/g,
              `<span class="changetext">①颜色</span>`
            );
          case 1:
            return str.replace(
              /②点数/g,
              `<span class="changetext">②点数</span>`
            );
          case 2:
            return str.replace(
              /③花色/g,
              `<span class="changetext">③花色</span>`
            );
          case 3:
            return str.replace(
              /④牌名/g,
              `<span class="changetext">④牌名</span>`
            );
        }
        return str;
      },
      xiangnuo(player) {
        ...
        switch (player.$.xiangnuo) {
          case 1:
            return str.replace(
              /①进入/g,
              `<span class="changetext">①进入</span>`
            );
          case 2:
            return str.replace(
              /②离开/g,
              `<span class="changetext">②离开</span>`
            );
        }
        return str;
      },
      qingsui(player) {
        ...
        switch (player.$.qingsui) {
          case 1:
            return str.replace(
              /①『集爱』/g,
              `${lib.spanClass(`①『集爱』`, "changetext")}`
            );
          case 2:
            return str.replace(
              /②『盛阴』/g,
              `${lib.spanClass(`②『盛阴』`, "changetext")}`
            );
          case 3:
            return str.replace(
              /③『全域』/g,
              `${lib.spanClass(`③『全域』`, "changetext")}`
            );
        }
        return str;
      },
      qitong(player) {
        ...
        switch (player.$.qitong) {
          case true:
            return str.replace(
              /①装备区/g,
              `${lib.spanClass(`①装备区`, "changetext")}`
            );
          case false:
            return str.replace(
              /②座次/g,
              `${lib.spanClass(`②座次`, "changetext")}`
            );
        }
        return str;
      },
      ...
      yinxu(player) {
        ...
        switch (player.$.yinxu) {
          case true:
            return str.replace(
              /①锦囊牌/g,
              `${lib.spanClass(`①锦囊牌`, "changetext")}`
            );
          case false:
            return str.replace(
              /②装备牌/g,
              `${lib.spanClass(`②装备牌`, "changetext")}`
            );
        }
        return str;
      },
